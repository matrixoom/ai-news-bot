...
- Market Data 股票“全部标的”刷新改为只刷新近 1 年日线与公司概况，不再批量刷新财务指标；15:30 自动刷新会先判断 A 股交易日，节假日休市跳过。
...
- Market Data 股票“全部标的”列表改为每页 15 支并压缩行高；列表标题左侧新增全标的刷新图标按钮和微型进度条，可后台刷新全部标的近 1 年日线和公司概况；每次任务按标的检查本地日线覆盖，已覆盖则跳过外部请求，并新增 15:30 自动刷新任务。
